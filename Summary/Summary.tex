...
$$\text{Bodyfat}_i = 153 \cdot \frac{ABDOMEN}{ \text{Weight} }
...
\section{Conclcusion}
In conclusion, we select \textbf{Fraction model as the final model.} This model is good in the sense that: 
...
\begin{itemize}
	\item Chao Change: Shiny App
	\item Yezhou Li: Summary (2.2 - )
	\item Shuyang Chen: Presentation Slides
	\item Ping YU: Summary ( - 2.1)
\end{itemize}
