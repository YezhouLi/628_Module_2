...
\begin{align*}
\text{Bodyfat} = 0.682 \times \text{Abeomen} -2.022 \times \text{Wrist}\\
				 -7.256, R^2 = 0.6832
\end{align*}
...
\\
$$\text{Bodyfat} = \frac{\beta_1 \mathbf{X}_i + \beta_2}{ \text{Weight}_i } + \beta_3$$
\\
We will use \textbf{10-fold Cross Validation} to find the best $\mathbf{X}_i$
